...
import org.ATBSelenium.listeners.RetryAnalizer;
...
public class VWO_Improved_POM_PropertiesReader_Retry_TestCase extends CommonToAllTest {

    private static final Logger logger = LogManager.getLogger(VWO_Improved_POM_PropertiesReader_Retry_TestCase.class);
    ...
    @Description("Verify that valid creds dashboard page is loaded")
    @Test
    public void testLoginNegativeVWOForRetry() {
        ...
        assertThat(usernameLoggedIn).isNotBlank().isNotNull().isNotEmpty();
        Assert.assertEquals(usernameLoggedIn, "Nithu");
    }
}